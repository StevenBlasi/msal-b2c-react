...
let _msal = require('msal');

let Msal = _interopRequireWildcard(_msal);
...
let logger = new Msal.Logger(loggerCallback, {
...
let authentication = {
    initialize: function initialize(config) {
        ...
        let authority = instance + '/' + config.tenant + '/oauth2/v2.0/authorize?p=' + config.signInPolicy;
        let validateAuthority = config.validateAuthority != null ? config.validateAuthority : true;
    ...
    required: function required(WrappedComponent, renderLoading) {
        return function (_React$Component) {
            ...
            function _class(props) {
                ...
                let _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, props));
